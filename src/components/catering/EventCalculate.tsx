...
import { hotReplacerOnlyDigits, hotReplacerPhone } from 'src/scripts/helpers/hotReplacers'

const options = ['Классическая', 'Грейпфрут', 'Помело', 'Ананас', 'Дыня']

export const EventCalculate: FunctionComponent = () => {
  ...
  return (
    <>
      <ModalContactShortly isOpen={modalIsOpen} closing={() => setModalIsOpen(false)} />
            ...
            <div>
              ...
              <div className='second-third'>
                <div className='second'>
                  <img src='/assets/images/catering/02gold.png' alt='' />
                ...
                <div className='third'>
                  <img src='/assets/images/catering/03gold.png' alt='' />
              ...
              <Button1 onClick={handleSubmit}>Заказать индивидуальный рассчет</Button1>
            </div>
          </div>
        </div>
      </section>
